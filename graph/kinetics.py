...
class AdjMatrixGraph:
    def __init__(self, labeling_mode='spatial'):
        ...
        self.A_binary = [tools.get_adjacency_matrix(self.inward[i] + self.outward[i], self.num_node[i]) for i in
                         range(len(self.num_node))]
        self.A_binary_with_I = [
            tools.get_adjacency_matrix(self.inward[i] + self.outward[i] + self.self_link[i], self.num_node[i]) for i in
            range(len(self.num_node))]
